...
export default class Tiers extends React.Component {
    ...
    render() {
        return (
            <div>
                <div>Первый ярус
                   <div>Ширина яруса<input type='text' 
                   value={this.state.width_tiers1} 
                   onChange={this.ChangeWidthTiers1}></input></div>
                    <div>Высота яруса<input type='text' 
                    value={this.state.height_tiers1} 
                    onChange={this.ChangeHeightTiers1}></input></div>
                ...
                onChange={this.ChangeWidthTiers2}></input></div>
                    <div>Высота яруса<input type='text' 
                    value={this.state.height_tiers2} 
                    onChange={this.ChangeHeightTiers2}></input></div>
                ...
                <div>Ширина яруса<input type='text'
                 value={this.state.width_tiers3} onChange={this.ChangeWidthTiers3}></input></div>
